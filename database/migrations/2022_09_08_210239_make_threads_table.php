...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('threads', function (Blueprint $table) {
            ...
            $table->timestamp('lastPinnedUpdated')->nullable(); // pinned posts go first, the ones with longer last_pinned_update timestamp at the topmost
            $table->timestamp('lastValidBumpAt')->nullable();
